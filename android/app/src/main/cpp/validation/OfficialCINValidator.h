...
struct CINLayoutConfig {
    ...
    static constexpr float FRONT_PHOTO_FLOOR = 0.20f;
    static constexpr float FRONT_FLAG_FLOOR  = 0.15f;
    ...
    static constexpr float BC_VEDGE_DENSITY_MIN = 0.08f;
    ...
    // Per-zone minimum floors (hard reject if critical zone below floor)
    static constexpr float BACK_FP_FLOOR = 0.20f;
    static constexpr float BACK_BC_FLOOR = 0.20f;
