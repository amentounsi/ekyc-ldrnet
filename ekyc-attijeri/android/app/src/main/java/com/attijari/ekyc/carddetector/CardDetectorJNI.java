...
public class CardDetectorJNI {
    ...
    /**
     * Prepare native state for back scan after a fresh initialize().
     * Sets captureState=WAIT_BACK and disables red validation.
     */
    public static native void nativePrepareBackScan();
