...
public class CardDetectorFrameProcessor extends FrameProcessorPlugin {
    ...
    public Object callback(@NonNull Frame frame, @Nullable Map<String, Object> arguments) {
        ...
        try {
            ...
            if (frameCount % 10 == 1) {
                android.util.Log.e(TAG, "[DIAG] Frame size: " + width + "x" + height + " orientation=" + frame.getOrientation().toString());
            }
            ...
            switch (orientStr.toLowerCase()) {
                ...
                case "landscape-right": rotationDegrees = 90;  break; // VisionCamera v4: landscape-right still needs 90° for portrait display
                default:                rotationDegrees = 90;  break; // safe default for portrait mode
            }
            if (frameCount % 10 == 1)
                android.util.Log.e(TAG, "[DIAG] orientStr=" + orientStr + " rot=" + rotationDegrees);
    ...
    private Map<String, Object> parseDetectionResult(float[] result, int width, int height, String orientation) {
        ...
        debug.put("temporalValidCount", Integer.valueOf((int) result[20]));
        // Warp info
