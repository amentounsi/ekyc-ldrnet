...
struct DetectionConfig {
    ...
    float appearanceStddevMax  = 60.f;  // INCREASED: allow more texture variation (CIN back has barcode+fingerprint)
    float appearanceMeanLowLight = 70.f;  // LOWERED: allow darker images
    float appearanceStddevMedium = 55.f;  // INCREASED: more tolerant combined rejection
